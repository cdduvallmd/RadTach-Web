...
export default function WeeklyReportTab({ userId, userSystem, formatTime, role = 'radiologist' }: WeeklyReportTabProps) {
  const [currentDate, setCurrentDate] = useState(new Date());
  const weekRange: DateRange = useMemo(() => getWeekRange(currentDate, 'monday'), [currentDate]);
